...
import com.school.tyari.adapter.AdapterReview;
import com.school.tyari.models.ModelReview;

public class BlogReviewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blog_reviews);
        ...
        ref.child("shopUid").child("Ratings")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterReview = new AdapterReview(BlogReviewsActivity.this,reviewArrayList);
                        //set to recyclerview
