...
import com.school.tyari.FilterProduct;
import com.school.tyari.R;
import com.school.tyari.activities.EditProductActivity;
...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        try {
            Picasso.get().load(icon).placeholder(R.drawable.ic_shop_primary).into(holder.productIconIv);
        }
        catch (Exception e){
    ...
    private void detailsBottomSheet(ModelProduct modelProduct) {
        ...
        try {
            Picasso.get().load(icon).placeholder(R.drawable.ic_shop_primary).into(productIconIv);
        }
        catch (Exception e){
